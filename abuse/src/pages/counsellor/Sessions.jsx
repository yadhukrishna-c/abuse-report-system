  ...
  return (
    <div className="sessions">
      ...
      {loading ? (
        ...
        <p className="sessions-error">{error}</p>
      ) : sessions.length === 0 ? (
        <div className="sessions-empty">No sessions assigned yet.</div>
      ) : (
          ...
          return (
            <div key={session._id} className="session-card">
              <div>
                ...
                <p className="session-time">{formatDateTime(session.createdAt)}</p>
                {hasMeetLink ? (
                  <p>
                ...
                <div className={`session-response-state ${userResponseState.tone}`}>
